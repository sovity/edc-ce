...
export class AssetService {
  ...
  public createAsset(
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/assets`,
      assetEntryDto,
      {
  ...
  public getAllAssets(
    ...
    reportProgress?: boolean,
    options?: {httpHeaderAccept?: 'application/json'; context?: HttpContext},
  ): Observable<HttpResponse<Array<AssetDto>>>;
  public getAllAssets(
    offset?: number,
    limit?: number,
    filter?: string,
    ...
    reportProgress?: boolean,
    options?: {httpHeaderAccept?: 'application/json'; context?: HttpContext},
  ): Observable<HttpEvent<Array<AssetDto>>>;
  public getAllAssets(
    offset?: number,
    limit?: number,
    filter?: string,
    ...
    return this.httpClient.get<Array<AssetDto>>(
      `${this.configuration.basePath}/assets`,
      {
        context: localVarHttpContext,
  ...
  public getAsset(
    ...
    reportProgress?: boolean,
    options?: {httpHeaderAccept?: 'application/json'; context?: HttpContext},
  ): Observable<HttpResponse<AssetDto>>;
  public getAsset(
    id: string,
    observe?: 'events',
    reportProgress?: boolean,
    options?: {httpHeaderAccept?: 'application/json'; context?: HttpContext},
  ): Observable<HttpEvent<AssetDto>>;
  public getAsset(
    id: string,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    return this.httpClient.get<AssetDto>(
      `${this.configuration.basePath}/assets/${encodeURIComponent(String(id))}`,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
  ...
  public removeAsset(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling removeAsset.',
      );
    }
