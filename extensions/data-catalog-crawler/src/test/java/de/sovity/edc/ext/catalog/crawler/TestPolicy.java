...
import de.sovity.edc.ext.catalog.crawler.client.gen.JSON;
...
public class TestPolicy {
    ...
    public static de.sovity.edc.client.gen.model.UiPolicyCreateRequest createAfterYesterdayPolicyEdcGen() {
        UiPolicyCreateRequest obj = createAfterYesterdayPolicy();
        return JsonTestUtils.jsonCast(obj, de.sovity.edc.client.gen.model.UiPolicyCreateRequest.class);
    }
    ...
    public static JSONB getPolicyJsonLd(UiPolicyCreateRequest createRequest) {
        var policyMapper = CrawlerExtensionContext.instance.policyMapper();
