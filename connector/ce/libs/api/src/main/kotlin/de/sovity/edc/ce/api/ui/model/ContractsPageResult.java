...
@Schema(description = "Contracts Page Result")
public class ContractsPageResult {
    @Schema(description = "List of contract agreements", requiredMode = Schema.RequiredMode.REQUIRED)
    private List<ContractsPageEntry> contracts;
