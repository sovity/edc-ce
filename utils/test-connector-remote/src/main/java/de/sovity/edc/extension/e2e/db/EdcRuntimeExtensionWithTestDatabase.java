...
public class EdcRuntimeExtensionWithTestDatabase
    ...
    @Getter
    private EdcRuntimeExtension edcRuntimeExtension = null;

    @Override
    public void beforeAll(ExtensionContext extensionContext) throws Exception {
        testDatabase.beforeAll(extensionContext);
        edcRuntimeExtension = new EdcRuntimeExtension(moduleName, logPrefix, propertyFactory.apply(testDatabase));
    }
}
