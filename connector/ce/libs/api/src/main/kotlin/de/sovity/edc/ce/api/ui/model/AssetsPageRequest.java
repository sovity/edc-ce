...
@Schema(description = "Properties to filter and sort the assets page")
public class AssetsPageRequest {
    @Nullable
    ...
    private List<SortByRequest<AssetsPageSortProperty>> sortBy;
}
