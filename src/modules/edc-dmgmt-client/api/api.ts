...
export const APIS = [ApplicationObservabilityService, AssetService, CatalogService, ContractAgreementService, ContractDefinitionService, ContractNegotiationService, DataplaneSelectorService, DefaultService, HTTPProvisionerWebhookService, IdentityHubService, PolicyService, TransferProcessService];
