...
import {ConnectorCardsComponent} from './connector-cards/connector-cards.component';
...
@NgModule({
  ...
  declarations: [ConnectorPageComponent, ConnectorCardsComponent],
  exports: [ConnectorPageComponent],
})
export class ConnectorPageModule {}
