...
class Ms8ConnectorTransferTest {
    ...
    void testMs8DataOffer_Properties() {
        ...
        SoftAssertions.assertSoftly(softly -> {
            ...
            softly.assertThat(asset.getAdditionalProperties()).isEmpty();
            softly.assertThat(asset.getAdditionalJsonProperties()).isEmpty();
            softly.assertThat(asset.getPrivateJsonProperties()).isEmpty();
            softly.assertThat(asset.getPrivateProperties()).isEmpty();
        });
    }
