...
@Schema(description = "Specify pagination for list pages")
public class PaginationRequest {
    @Nullable
    @Schema(description = "Page Index. Defaults to 1", requiredMode = Schema.RequiredMode.NOT_REQUIRED, defaultValue = "1")
