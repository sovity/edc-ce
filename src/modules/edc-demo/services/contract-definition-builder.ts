...
} from "../components/contract-definition-editor-dialog/contract-definition-editor-dialog-form-model";
...
export class ContractDefinitionBuilder {
   ...
   */
  buildContractDefinition(formValue: ContractDefinitionEditorDialogFormValue): ContractDefinitionDto {
    return {
