...
@Schema(
    description = "Available authentication methods for http data sources. Use only one."
)
public class UiHttpAuth {

    @Schema(
        description = "The type of authentication.",
        requiredMode = Schema.RequiredMode.REQUIRED
    )
    private UiHttpAuthType type;
    ...
    private UiHttpAuthOauth2 oauth;
