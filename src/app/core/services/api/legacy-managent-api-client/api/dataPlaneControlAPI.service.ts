...
export class DataPlaneControlAPIService {
  ...
  public getTransferState(
    ...
    if (processId === null || processId === undefined) {
      throw new Error(
        'Required parameter processId was null or undefined when calling getTransferState.',
      );
    }
    ...
    return this.httpClient.get<any>(
      `${this.configuration.basePath}/transfer/${encodeURIComponent(
        String(processId),
      )}`,
      {
  ...
  public initiateTransfer(
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/transfer`,
      dataFlowRequest,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
