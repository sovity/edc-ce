...
public class TestAsset {
    ...
    public static void setDataOfferAssetMetadata(DataOfferRecord dataOfferRecord, JsonObject assetJsonLd, String participantId) {
        ...
        var fetchedCatalogBuilder = CrawlerExtensionContext.instance.catalogPatchBuilder();
        var dataOfferRecordUpdater = CrawlerExtensionContext.instance.dataOfferRecordUpdater();
