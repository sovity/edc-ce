...
class AssetMapperTest {
    ...
    void setup() {
        ...
        assetMapper = Factory.newAssetMapper(typeTransformerRegistry, endpoint::equals);;
    }
    ...
    void test_buildAssetDto() {
        ...
        assertThat(uiAsset.getIsOwnConnector()).isTrue();
        ...
        assertThat(uiAsset.getTransportMode()).isEqualTo("my-transport-mode");
        ...
        assertThat(uiAsset.getDataSourceAvailability()).isEqualTo(DataSourceAvailability.LIVE);
