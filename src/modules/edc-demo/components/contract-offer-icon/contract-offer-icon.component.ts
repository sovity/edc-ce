...
@Component({
  ...
  template: `
      ...
      <div *ngIf="contractNegotiationService.isNegotiated(contractOffer)" style="position: absolute;">
          <mat-icon style="
            margin-top: 3px;
            margin-left: 9px;
            font-weight: bold;
      ...
      <!-- Icon -->
      <mat-icon style="font-size: 40px; width: 40px; height: 40px; min-width: 40px">sim_card</mat-icon>
  `
})
