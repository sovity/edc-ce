...
export class HTTPProvisionerWebhookService {
  ...
  public callDeprovisionWebhook(
    ...
    if (processId === null || processId === undefined) {
      throw new Error(
        'Required parameter processId was null or undefined when calling callDeprovisionWebhook.',
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/callback/${encodeURIComponent(
        String(processId),
      )}/deprovision`,
  ...
  public callProvisionWebhook(
    processId: string,
    provisionerWebhookRequest?: ProvisionerWebhookRequest,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {httpHeaderAccept?: 'application/json'; context?: HttpContext},
  ): Observable<any>;
  ...
  public callProvisionWebhook(
    ...
    if (processId === null || processId === undefined) {
      throw new Error(
        'Required parameter processId was null or undefined when calling callProvisionWebhook.',
      );
    }
