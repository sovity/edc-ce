...
## Choice: `sovity.dataspace.kind`=`railway-x`

Configures the connector Catena-X compliant and Tractus-X compatible while disabling the data exchange governance credential and further enhancing it with sovity features
...
<details><summary>Show / Hide (10)</summary>
