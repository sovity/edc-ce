 ...
 */
@MigrationSensitive(
    changes = "Replaces DataPlaneManagerImpl with SovityDataPlaneManagerImpl to fix this bug: https://github.com/eclipse-edc/Connector/pull/4982"
        + "Can be removed as of EDC 0.13.0 since the bug is fixed there.",
    dependsOn = DataPlaneFrameworkExtension.class
)
@Provides({DataPlaneManager.class, TransferServiceRegistry.class})
@Extension(value = SovityDataPlaneFrameworkExtension.NAME)
public class SovityDataPlaneFrameworkExtension implements ServiceExtension {
    ...
    @Configuration
    private DataPlaneFrameworkExtension.FlowLeaseConfiguration flowLeaseConfiguration;

    private SovityDataPlaneManagerImpl dataPlaneManager;
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        dataPlaneManager = SovityDataPlaneManagerImpl.Builder.newInstance()
