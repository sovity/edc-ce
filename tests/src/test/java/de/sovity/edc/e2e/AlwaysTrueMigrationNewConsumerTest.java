...
public class AlwaysTrueMigrationNewConsumerTest {
    ...
    public void always_true_agreements_still_work_after_migration(
        ...
        UiPolicyExpression oldAlwaysTrueExpression = oldAlwaysTruePolicyOnProvider.getPolicy().getExpression();
        UiPolicyExpression newAlwaysTrueExpression = newAlwaysTruePolicyOnConsumer.getPolicy().getExpression();
