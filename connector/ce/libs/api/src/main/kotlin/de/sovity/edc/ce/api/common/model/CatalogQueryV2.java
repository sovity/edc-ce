...
public class CatalogQueryV2 {
    ...
    @Schema(description = "Conjunction of filter expressions for data offer filtering", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(description = "Field to sort by", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private CatalogSortBy sortBy;
}
