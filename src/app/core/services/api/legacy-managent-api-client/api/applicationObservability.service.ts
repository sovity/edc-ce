...
export class ApplicationObservabilityService {
  ...
  ): Observable<Array<HealthStatus>>;
  public checkHealth(
    observe?: 'response',
    reportProgress?: boolean,
    options?: {httpHeaderAccept?: 'application/json'; context?: HttpContext},
  ): Observable<HttpResponse<Array<HealthStatus>>>;
  public checkHealth(
    observe?: 'events',
    reportProgress?: boolean,
    options?: {httpHeaderAccept?: 'application/json'; context?: HttpContext},
  ): Observable<HttpEvent<Array<HealthStatus>>>;
  public checkHealth(
    observe: any = 'body',
    ...
    return this.httpClient.get<Array<HealthStatus>>(
      `${this.configuration.basePath}/check/health`,
      {
  ...
  public getLiveness(
    ...
    return this.httpClient.get<Array<HealthStatus>>(
      `${this.configuration.basePath}/check/liveness`,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
  ...
  public getReadiness(
    ...
    return this.httpClient.get<Array<HealthStatus>>(
      `${this.configuration.basePath}/check/readiness`,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
  ...
  public getStartup(
    ...
    return this.httpClient.get<Array<HealthStatus>>(
      `${this.configuration.basePath}/check/startup`,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
