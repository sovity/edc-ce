...
export class TransferProcessService {
  ...
  public cancelTransferProcess(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling cancelTransferProcess.',
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/transferprocess/${encodeURIComponent(
        String(id),
      )}/cancel`,
      null,
      {
  ...
  public deprovisionTransferProcess(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling deprovisionTransferProcess.',
      );
    }
  ...
  public getAllTransferProcesses(
    ...
    return this.httpClient.get<Array<TransferProcessDto>>(
      `${this.configuration.basePath}/transferprocess`,
      {
        context: localVarHttpContext,
  ...
  public getTransferProcess(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getTransferProcess.',
      );
    }
    ...
    return this.httpClient.get<TransferProcessDto>(
      `${this.configuration.basePath}/transferprocess/${encodeURIComponent(
        String(id),
      )}`,
      {
  ...
  public getTransferProcessState(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getTransferProcessState.',
      );
    }
    ...
    return this.httpClient.get<TransferState>(
      `${this.configuration.basePath}/transferprocess/${encodeURIComponent(
        String(id),
      )}/state`,
      {
