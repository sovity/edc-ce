...
@Schema(description = "Contract Negotiation state")
public class ContractNegotiationStateResult {
    ...
    @Schema(description = "Contract Agreement ID", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String contractAgreementId;

    @Schema(description = "Contract Agreement Termination State", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private ContractAgreementTerminationInfo contractAgreementTerminationInfo;
