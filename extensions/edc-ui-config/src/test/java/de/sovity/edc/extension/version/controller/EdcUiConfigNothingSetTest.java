...
class EdcUiConfigNothingSetTest {
    ...
    void testEdcUiConfigWithNothingSet() {
        mockRequest().assertThat()
                .body("EDC_UI_CONNECTOR_ENDPOINT", equalTo("http://property.edc-ids-endpoint.not" +
                        ".set.in.edc.backend/ids/data"))
                .body("EDC_UI_CONNECTOR_NAME", equalTo(missingMessage("EDC_UI_CONNECTOR_NAME",
                        "edc.connector.name")))
                .body("EDC_UI_IDS_ID", equalTo(missingMessage("EDC_UI_IDS_ID", "edc.ids.id")))
                .body("EDC_UI_IDS_TITLE", equalTo(missingMessage("EDC_UI_IDS_TITLE", "edc.ids" +
                        ".title")))
                .body("EDC_UI_IDS_DESCRIPTION", equalTo(missingMessage("EDC_UI_IDS_DESCRIPTION",
                        "edc.ids.description")))
                .body("EDC_UI_CURATOR_URL", equalTo(missingMessage("EDC_UI_CURATOR_URL", "edc.ids" +
                        ".curator")))
                .body("EDC_UI_MAINTAINER_URL", equalTo(missingMessage("EDC_UI_MAINTAINER_URL",
                        "edc.ids.maintainer")))
                .body("EDC_UI_DAPS_OAUTH_TOKEN_URL", equalTo(missingMessage(
                        "EDC_UI_DAPS_OAUTH_TOKEN_URL", "edc.oauth.token.url")))
                .body("EDC_UI_DAPS_OAUTH_JWKS_URL", equalTo(missingMessage(
                        "EDC_UI_DAPS_OAUTH_JWKS_URL", "edc.oauth.provider.jwks.url")));
    }
