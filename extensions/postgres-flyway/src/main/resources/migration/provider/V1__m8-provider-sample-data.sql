...
INSERT INTO public.edc_asset (asset_id, created_at) VALUES ('urn:artifact:test:1.0', 1687179246852);
...
INSERT INTO public.edc_asset_dataaddress (asset_id_fk, properties) VALUES ('urn:artifact:test:1.0', '{"baseUrl":"http://localhost:11000/api/test-backend/provide/b130536e-0a51-4d2d-aa8c-7591d6ad5bc8","method":"GET","type":"HttpData"}');
...
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'asset:prop:curatorOrganizationName', 'Example GmbH', 'java.lang.String');
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'http://w3id.org/mds#transportMode', 'Road', 'java.lang.String');
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'asset:prop:contenttype', 'application/json', 'java.lang.String');
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'asset:prop:version', '1.0', 'java.lang.String');
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'http://w3id.org/mds#geoReferenceMethod', 'Geo reference method', 'java.lang.String');
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'asset:prop:id', 'urn:artifact:test:1.0', 'java.lang.String');
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'http://w3id.org/mds#dataModel', 'Data Model', 'java.lang.String');
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'http://w3id.org/mds#dataSubcategory', 'Accidents', 'java.lang.String');
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'asset:prop:language', 'https://w3id.org/idsa/code/EN', 'java.lang.String');
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'asset:prop:keywords', 'keyword1, keyword2', 'java.lang.String');
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'asset:prop:name', 'test', 'java.lang.String');
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'asset:prop:description', 'My Asset Description', 'java.lang.String');
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'http://w3id.org/mds#dataCategory', 'Traffic Information', 'java.lang.String');
INSERT INTO public.edc_asset_property (asset_id_fk, property_name, property_value, property_type) VALUES ('urn:artifact:test:1.0', 'asset:prop:originator', 'http://edc:11003/api/v1/ids/data', 'java.lang.String');
